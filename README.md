...
### Механизмы
#### Лазер
Теги: Статичен, задний <br>
Размер: плиту с выпирабщей в центре частью 0.25x1 <br>
Особености: Луч можно отключить если подать сигнал, испускает лазернай луч в одном направлении, луч убивает при соприкосновении. Луч имеет длинну до ближайшего твёрдого объекта.<br>
Вид: Пока не известен, цвет луча - крастный. <br>
### Прочее
#### блок игрока
